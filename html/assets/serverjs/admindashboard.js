 ...
 .then((data) => {
    ...
    jsondata.loans.forEach(loan => {
      ...
      <td>
                                 ...
                                 <td><a class="button" type="button" style="border: 1px solid #FF971D; padding: 0.2rem; color: white; background-color: green;">Approve</a>
                                  <a class="button" type="button" style="border: 1px solid #FF971D; padding: 0.2rem; color: white; background-color: red;">Reject</a></td>
      `;
